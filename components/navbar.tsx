...
export default function Navbar() {
  ...
  useEffect(()=>{
    document.addEventListener('click', (e)=>{
        if(isMobileMenuOpen && !nav_el.current.contains(e.target)) {
            toggleMobileMenu()
        }
    })
  })
  ...
  return (
      <nav className="block w-full max-w-screen px-4 py-4 mx-auto bg-white bg-opacity-90 sticky top-0 shadow lg:px-8 backdrop-blur-lg backdrop-saturate-150 z-[9999]" ref={nav_el}>
