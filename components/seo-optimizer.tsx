...
const DEFAULT_SEO: SEOConfig = {
  ...
  description:
    "免费的在线简历编辑器，提供专业模板、AI优化建议和一键导出功能。快速创建令人印象深刻的简历。",
  keywords: [
    "简历编辑器",
    "简历制作",
    "简历模板",
  ...
  if (resumeData) {
    ...
    if (personalInfo.summary) {
      seoConfig.description =
        personalInfo.summary.length > 160
    ...
    <>
      <Head>
        ...
        <meta
          ...
          content={seoConfig.locale || "zh-CN"}
        />
