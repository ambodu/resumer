...
export default function TemplatesPage() {
  return (
    <main className="min-h-screen p-6 bg-gray-50 dark:from-gray-500 dark:bg-black">
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="text-center space-y-4">
          <h1 className="text-4xl font-bold tracking-tighter dark:text-white">Resume Templates</h1>
